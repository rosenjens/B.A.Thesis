...
Consequently having a stationary keyboard is a bad idea and could mean that the users is either too far away or pressing more keys than intended. The solution where measuring the speed of the fingers lets the user choose at what hight to write and be allowed to drift horizontally with the hands and still be able to type. 
